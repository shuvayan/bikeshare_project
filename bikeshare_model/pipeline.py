...
bikeshare_pipe = Pipeline([
    ...
    ######### Imputation ###########
    ('weekday_imputation', WeekdayImputer(variable = config.process_config.weekday_var, 
                                          date_var= config.process_config.date_var)),
    ('weathersit_imputation', WeathersitImputer(variable = config.process_config.weathersit_var)),
