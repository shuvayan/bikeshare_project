...
def run_training() -> None:
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        ...
        data[config.process_config.features],     # predictors
        data[config.process_config.target],       # target
        test_size = config.process_config.test_size,
        random_state=config.process_config.random_state,   # set the random seed here for reproducibility
    )
